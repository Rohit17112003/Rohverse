...
const Quotes = () => {
  return (
    <div className="w-full">
      <div className="w-full  lg:w-[70%] flex flex-col  mx-auto items-end">
        <div className="w-full border border-gray p-4 sm:p-[2rem] relative flex justify-center">
          {/* top design  */}
          <span className="absolute -top-2 left-3 bg-dark px-1">
            <svg
          ...
          {/* bottom design  */}
          <span className="absolute -bottom-2 right-3 bg-dark px-1 z-10">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="26"
              height="21"
        ...
        <div className="w-[30%] sm:w-[25%] border border-gray p-3 sm:p-[1.2rem] relative flex justify-center ">
          <span className="text-[0.8rem] sm:text-[1.5rem] text-white font-[400]">
            - Dr. Who
          </span>
        </div>
      </div>
